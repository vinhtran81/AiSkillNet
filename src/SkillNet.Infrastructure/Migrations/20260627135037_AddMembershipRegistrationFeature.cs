...
{
    /// <inheritdoc />
    public partial class AddMembershipRegistrationFeature : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MembershipApplications_ServicePackages_ServicePackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipApplications_ServicePackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipApplications_UserId_Status",
                table: "MembershipApplications",
                columns: new[] { "UserId", "Status" });

            migrationBuilder.CreateIndex(
                name: "UX_MembershipApplications_OnePendingPerUser",
                table: "MembershipApplications",
                column: "UserId",
                unique: true,
